...
import Link from 'next/link'; // Ainda pode ser útil para outros links internos, se houver
...
import { ProductForm } from '@/app/(app)/products/components/ProductForm'; // Ajuste de caminho
import { CostDisplayDialog } from '@/app/(app)/products/components/CostDisplayDialog'; // Ajuste de caminho
